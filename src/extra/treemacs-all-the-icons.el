...
(treemacs-create-theme "all-the-icons"
  ...
  (progn
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "vhdl" :v-adjust 0 :face 'all-the-icons-dblue) treemacs-all-the-icons-tab) :extensions ("vhdl" "vhd") :fallback 'same-as-icon)
